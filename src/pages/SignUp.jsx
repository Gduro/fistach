...
export default function SignUp() {
  ...
  return (
    <main className="w-full h-screen flex flex-col items-center justify-center bg-purple-200 sm:px-4">
      <div className="w-full space-y-6 text-gray-600 sm:max-w-md ">
        ...
        <div className="bg-purple-50 shadow p-4 py-6 sm:p-6 sm:rounded-lg">
